...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudfare-test)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cloudfare-test
```

A live public deployment of this template is available at [https://cloudfare-test.templates.workers.dev](https://cloudfare-test.templates.workers.dev)
